...
export class ScreenCapture {
  ...
  private startIdleTimer(): void {
    ...
    this.idleTimer = this.timer.setTimeout(() => {
      ...
      // Also exclude prompt-indicator lines where the marker appears with at most 2
      // trailing characters — these are Claude Code's idle prompt, cursor
      // remnants, or short Ink TUI artifacts, not active spinners. Real
      // spinner lines (e.g. "Analyzing code...") always have 3+ chars after the marker.
